...
class _View_AuthenticationComponent0 extends import1.AppView<import3.AuthenticationComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._text_9 = this.renderer.createText(this._el_8,'Bienvenido',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import15.RouterOutlet) && (22 === requestNodeIndex))) { return this._RouterOutlet_22_5; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    changes = (null as any);
    const currVal_2:any = this._arr_0('welcome');
    ...
    const currVal_5:boolean = !this.context.isLoggedIn();
    if (import4.checkBinding(throwOnChange,this._expr_5,currVal_5)) {
      this._NgIf_13_6.ngIf = currVal_5;
      this._expr_5 = currVal_5;
    }
    const currVal_6:any = this.context.isLoggedIn();
...
export function viewFactory_AuthenticationComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AuthenticationComponent> {
  if ((renderType_AuthenticationComponent === (null as any))) { (renderType_AuthenticationComponent = viewUtils.createRenderComponentType('C:/Users/Farid/Documents/angular2/messages-example/assets/app/auth/authentication.component.ts class AuthenticationComponent - inline template',0,import9.ViewEncapsulation.None,styles_AuthenticationComponent,{})); }
