...
class _View_ErrorComponent0 extends import1.AppView<import3.ErrorComponent> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_4:any = import4.interpolate(1,'',((this.context.error == (null as any))? (null as any): this.context.error.content),'');
...
export function viewFactory_ErrorComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.ErrorComponent> {
  if ((renderType_ErrorComponent === (null as any))) { (renderType_ErrorComponent = viewUtils.createRenderComponentType('C:/Users/Farid/Documents/angular2/messages-example/assets/app/errors/error.component.html',0,import9.ViewEncapsulation.Emulated,styles_ErrorComponent,{})); }
