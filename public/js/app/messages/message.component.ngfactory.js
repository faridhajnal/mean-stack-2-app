...
function viewFactory_MessageComponent_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessageComponent_Host === null)) {
        (renderType_MessageComponent_Host = viewUtils.createRenderComponentType('', 0, import10.ViewEncapsulation.None, [], {}));
    }
    return new _View_MessageComponent_Host0(viewUtils, parentInjector, declarationEl);
}
export var MessageComponentNgFactory = new import11.ComponentFactory('app-message', viewFactory_MessageComponent_Host0, import3.MessageComponent);
...
export function viewFactory_MessageComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessageComponent === null)) {
        (renderType_MessageComponent = viewUtils.createRenderComponentType('C:/Users/Farid/Documents/angular2/messages-example/assets/app/messages/message.component.html', 0, import10.ViewEncapsulation.Emulated, styles_MessageComponent, {}));
    }
