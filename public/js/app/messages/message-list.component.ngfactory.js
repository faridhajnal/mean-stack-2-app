...
import * as import16 from 'angular2-cookie/services/cookies.service';
...
export function viewFactory_MessageListComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessageListComponent === null)) {
        (renderType_MessageListComponent = viewUtils.createRenderComponentType('C:/Users/Farid/Documents/angular2/messages-example/assets/app/messages/message-list.component.ts class MessageListComponent - inline template', 0, import9.ViewEncapsulation.None, styles_MessageListComponent, {}));
    }
...
var _View_MessageListComponent1 = (function (_super) {
    ...
    _View_MessageListComponent1.prototype.createInternal = function (rootSelector) {
        ...
        this._MessageComponent_0_4 = new import14.MessageComponent(this.parent.parentInjector.get(import8.MessageService), this.parent.parentInjector.get(import16.CookieService));
