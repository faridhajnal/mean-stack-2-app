...
var _View_AuthenticationComponent_Host0 = (function (_super) {
    ...
    _View_AuthenticationComponent_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._AuthenticationComponent_0_4.ngOnInit();
        }
...
var _View_AuthenticationComponent0 = (function (_super) {
    ...
    _View_AuthenticationComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_9 = this.renderer.createText(this._el_8, 'Bienvenido', null);
        ...
        this._appEl_15 = new import2.AppElement(15, 5, this, this._anchor_15);
        this._TemplateRef_15_5 = new import20.TemplateRef_(this._appEl_15, viewFactory_AuthenticationComponent3);
    ...
    _View_AuthenticationComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import15.RouterOutlet) && (22 === requestNodeIndex))) {
    ...
    _View_AuthenticationComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        changes = null;
        var currVal_2 = this._arr_0('welcome');
        ...
        var currVal_6 = this.context.isLoggedIn();
...
export function viewFactory_AuthenticationComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AuthenticationComponent === null)) {
        (renderType_AuthenticationComponent = viewUtils.createRenderComponentType('C:/Users/Farid/Documents/angular2/messages-example/assets/app/auth/authentication.component.ts class AuthenticationComponent - inline template', 0, import9.ViewEncapsulation.None, styles_AuthenticationComponent, {}));
    }
...
var _View_AuthenticationComponent3 = (function (_super) {
    ...
    _View_AuthenticationComponent3.prototype._handle_click_1_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._RouterLinkWithHref_1_3.onClick($event.button, $event.ctrlKey, $event.metaKey) !== false);
        return (true && pd_0);
    };
