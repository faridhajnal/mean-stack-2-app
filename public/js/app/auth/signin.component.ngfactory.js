...
var _View_SigninComponent0 = (function (_super) {
    ...
    _View_SigninComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import13.FormGroupDirective) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 22)))) {
            return this._FormGroupDirective_2_3;
        }
        if (((token === import20.ControlContainer) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 22)))) {
            return this._ControlContainer_2_4;
        }
        if (((token === import14.NgControlStatusGroup) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 22)))) {
...
export function viewFactory_SigninComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SigninComponent === null)) {
        (renderType_SigninComponent = viewUtils.createRenderComponentType('C:/Users/Farid/Documents/angular2/messages-example/assets/app/auth/signin.component.html', 0, import11.ViewEncapsulation.None, styles_SigninComponent, {}));
    }
