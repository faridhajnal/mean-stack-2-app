    ...
    Object.defineProperty(_View_AppComponent_Host0.prototype, "_MessageService_0_5", {
        get: function () {
            if ((this.__MessageService_0_5 == null)) {
                (this.__MessageService_0_5 = new import4.MessageService(this.parentInjector.get(import9.Http), this.parentInjector.get(import10.CookieService), this.parentInjector.get(import11.ErrorService)));
            }
...
export var AppComponentNgFactory = new import13.ComponentFactory('my-app', viewFactory_AppComponent_Host0, import3.AppComponent);
...
var _View_AppComponent0 = (function (_super) {
    ...
    _View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_2 = import17.viewFactory_HeaderComponent0(this.viewUtils, this.injector(2), this._appEl_2);
        ...
        this._RouterOutlet_6_5 = new import15.RouterOutlet(this.parentInjector.get(import18.RouterOutletMap), this._appEl_6.vcRef, this.parentInjector.get(import19.ComponentFactoryResolver), null);
        ...
        var compView_9 = import20.viewFactory_ErrorComponent0(this.viewUtils, this.injector(9), this._appEl_9);
    ...
    _View_AppComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import15.RouterOutlet) && (6 === requestNodeIndex))) {
            return this._RouterOutlet_6_5;
        }
        if (((token === import16.ErrorComponent) && (9 === requestNodeIndex))) {
...
export function viewFactory_AppComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AppComponent === null)) {
        (renderType_AppComponent = viewUtils.createRenderComponentType('C:/Users/Farid/Documents/angular2/messages-example/assets/app/app.component.html', 0, import12.ViewEncapsulation.None, styles_AppComponent, {}));
    }
